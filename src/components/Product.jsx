...
export default function Product({post}) {
  ...
  return (
    <div className='flex flex-col justify-between items-center rounded-lg gap-3 p-4 mt-10 ml-5
                    shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:scale-110 transition duration-300 
